...
from crud_ajax.views import (display, displaylogs)
urlpatterns = [
    ...
    path('ajax/crud/show/', views.ShowCrudUser.as_view(), name='crud_ajax_show'),
    path('ajax/crud/listusers/', display, name='crud_ajax_display'),
    path('logs/', views.LogView.as_view(), name='logs'),
    path('ajax/logs/logs', displaylogs, name='logs_ajax'),
]
